...
extern uint32_t cmd_bleNextCommandInsertionPointer;
extern uint32_t cmd_bleCommandsInQue;
extern char cmd_bleCommandsInQueBuffer[SIZE_OF_COMMAND_QUEUE][MAX_COMMAND_LEN];
